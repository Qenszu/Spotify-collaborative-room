...
def refresh_spotify_token(session_id):
    old_tokens = get_user_tokens(session_id)
    if not old_tokens:
        return
    
    current_refresh_token = old_tokens.refresh_token
    ...
    update_or_create_user_token(session_id, access_token, token_type, expires_in, new_refresh_token)
